...
.EXAMPLE
    # re-point the whole profile at a different account
    .\setup.ps1 -Username tarun0648 -Name "Tarun S" -Image .\assets\tarun.png -Color

.EXAMPLE
    # regenerate art only, with different dot settings
    .\setup.ps1 -Image .\assets\tarun.png -Cols 110 -Color
#>
[CmdletBinding()]
param(
    [string]$Username,
